...
%Load Virtual Space
fid = fopen('shoe_surface_257x257.wrl','r'); % Pointwise export file
textscan(fid, '%*s %*[^\n]', 5); % Skip header text
...
%Load Physical Space
fid = fopen('shoe_surface_257x257.wrl','r');
textscan(fid,'%*s %*[^\n]', 5);
...
i=257; %Points in the i-direction 
j=257; %number of POINTS in the j-direction
eps_virtual=1;
